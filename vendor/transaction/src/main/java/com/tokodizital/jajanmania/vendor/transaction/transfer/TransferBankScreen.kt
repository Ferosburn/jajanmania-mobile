...
import com.tokodizital.jajanmania.vendor.transaction.transfer.component.BalanceSection

@ExperimentalMaterial3Api
@Composable
fun TransferBankScreen(
    ...
    Scaffold(
        topBar = {
            DetailTopAppBar(title = "Transfer Bank", onNavigationClicked = navigateUp)
        },
        modifier = modifier,
        bottomBar = {
            Box(
